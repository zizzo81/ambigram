...
![Gli oggetti voltanti](./Guide/floating_objects.png)

Si salvi l'oggetto come file STL.

Se si utilizza Parametric Model Maker di MakerWorld, si faccia click sul pulsante ![Generate](./Guide/generate_button.png) per assicurarsi di applicare le ultime modifiche ai parametri, quindi, una volta caricato l''oggetto a video, fare click sul pulsante ![Download](./Guide/download_button.png) per scaricare il file.

Quando si aprirà questa finestra di dialogo

![Finestra di selezione del formato di download](./Guide/download_selection.png)

Fare click sul pulsante ![Download STL](./Guide/download_stl.png) per scaricare la versione STL.

![Dialog salva file con nome](./Guide/save_as_it.png)
...
![Non acquisire cronologia progetto](./Guide/design_history_menu_it.png)
...
![Eliminazione oggetti indesiderati](./Guide/delete_floating_object_it.png)
...
![Drag STL over Bambu Studio](./Guide/dragndrop_it.png)
...
![Lista dei font in Font Book](./Guide/fontbook_list_it.png)
...
![Dettaglio del font in Font Book](./Guide/fontbook_detail_it.png)
...
![Cheat sheet index](./Guide/cheat_sheet_index.png)
